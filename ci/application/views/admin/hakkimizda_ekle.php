        ...
        <div id="page-wrapper">
		  <div class="header"> 
                        <h1 class="page-header">
                            Anasayfa <small>Hakkımızda Ekleme Sayfası</small>
                        </h1>
            ...
            <form action="<?=base_url()?>admin/home/hakkimizda_guncelle/<?=$veri[0]->Id?>" method="POST" >
			<textarea class="form-control" name="aciklama" rows="20"><?=$veri[0]->hakkimizda?></textarea><br>
			<script>
